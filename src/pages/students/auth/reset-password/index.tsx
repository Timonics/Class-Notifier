    ...
    <section className="pt-20 md:pt-52 h-screen px-8 md:px-12">
      ...
      <div className="mt-12 montserrat space-y-6">
        ...
        <div className="relative">
          ...
          />
          <input
            className="placeholder:text-[#D9D9D9] focus:outline-none rounded-lg border border-[#32073F80] text-[#32073F] w-full placeholder:text-lg h-14 pl-12 pr-4 bg-white"
